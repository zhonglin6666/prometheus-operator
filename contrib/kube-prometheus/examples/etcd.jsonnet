local kp = (import 'kube-prometheus/kube-prometheus.libsonnet') +
  ...
  _config+:: {
    ...
    // Reference info: https://gitlab.300.cn/paas-k8s/prometheus-operator/blob/master/contrib/kube-prometheus/README.md#static-etcd-configuration
    etcd+:: {
      // Configure this to be the IP(s) to scrape - i.e. your etcd node(s) (use commas to separate multiple values).
      ips: ['127.0.0.1'],

      // Reference info:
      //  * https://gitlab.300.cn/paas-k8s/prometheus-operator/blob/master/Documentation/api.md#servicemonitorspec (has endpoints)
      //  * https://gitlab.300.cn/paas-k8s/prometheus-operator/blob/master/Documentation/api.md#endpoint (has tlsConfig)
      //  * https://gitlab.300.cn/paas-k8s/prometheus-operator/blob/master/Documentation/api.md#tlsconfig (has: caFile, certFile, keyFile, serverName, & insecureSkipVerify)
