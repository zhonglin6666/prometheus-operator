...
local kp =
  ...
  (import 'kube-prometheus/kube-prometheus-bootkube.libsonnet') +
  {
    ...
    prometheus+:: {
      prometheus+: {
        spec+: {  // https://gitlab.300.cn/paas-k8s/prometheus-operator/blob/master/Documentation/api.md#prometheusspec
          ...
          // Reference info: https://gitlab.300.cn/paas-k8s/prometheus-operator/blob/master/Documentation/user-guides/storage.md
          ...
          storage: {  // https://gitlab.300.cn/paas-k8s/prometheus-operator/blob/master/Documentation/api.md#storagespec
            ...
            // The following 'selector' is only needed if you're using manual storage provisioning (https://gitlab.300.cn/paas-k8s/prometheus-operator/blob/master/Documentation/user-guides/storage.md#manual-storage-provisioning).
