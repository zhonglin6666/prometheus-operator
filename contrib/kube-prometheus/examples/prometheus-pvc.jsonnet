...
local kp =
  ...
  (import 'kube-prometheus/kube-prometheus-bootkube.libsonnet') +
  {
    ...
    prometheus+:: {
      prometheus+: {
        spec+: {  // https://github.com/zhonglin6666/prometheus-operator/blob/master/Documentation/api.md#prometheusspec
          ...
          // Reference info: https://github.com/zhonglin6666/prometheus-operator/blob/master/Documentation/user-guides/storage.md
          ...
          storage: {  // https://github.com/zhonglin6666/prometheus-operator/blob/master/Documentation/api.md#storagespec
            ...
            // The following 'selector' is only needed if you're using manual storage provisioning (https://github.com/zhonglin6666/prometheus-operator/blob/master/Documentation/user-guides/storage.md#manual-storage-provisioning).
