...
For a full description see: https://gitlab.300.cn/paas-k8s/prometheus-operator/pull/1984#issue-221139702
...
```bash
go get -u gitlab.300.cn/paas-k8s/prometheus-operator/cmd/po-rule-migration
po-rule-migration \
