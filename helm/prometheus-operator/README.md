...
Installs [prometheus-operator](https://gitlab.300.cn/paas-k8s/prometheus-operator) to create/configure/manage Prometheus clusters atop Kubernetes.
...
This chart bootstraps a [prometheus-operator](https://gitlab.300.cn/paas-k8s/prometheus-operator) deployment on a [Kubernetes](http://kubernetes.io) cluster using the [Helm](https://helm.sh) package manager.
